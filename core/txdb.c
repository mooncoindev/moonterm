                 ...
                 bool          *relevant)
{
   ...
   *relevant = 1;
   ...
   if (bitc_state_ready()) {
      ...
      bitcui_set_status("New payment %s: %.8f MOON",
                  ...
                  uint64                   *change)
{
   ...
   printf("value %lld desc->total_value %lld", value, desc->total_value);
              ...
              btc_msg_tx               *tx)
{
   ...
   if (change > 0) {
      ...
      Warning(LGPFX" change: %llu -- %.8f MOON\n", change, change / ONE_BTC);
   }
